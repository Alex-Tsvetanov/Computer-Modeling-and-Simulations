...
\begin{center}
    ...
    {\fontsize{20}{24}\selectfont\bfseries КУРСОВА РАБОТА\par}
    ...
    {\fontsize{14}{16.8}\selectfont\bfseries Тема 31: Моделиране на система за обработка на сензорни данни с крайни срокове\par}
    ...
    доц. д-р инж.	Валентин Христов\par
    \end{flushleft}
