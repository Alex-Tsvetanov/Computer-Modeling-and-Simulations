...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        0.025 & 40 & \textit{(Попълнете от GPSS)} \\
        \hline
        0.050 & 20 & \textit{(Попълнете от GPSS)} \\
        \hline
        0.075 & 13.33 & \textit{(Попълнете от GPSS)} \\
        \hline
        0.100 & 10 & \textit{(Попълнете от GPSS)} \\
        \hline
        0.150 & 6.67 & \textit{(Попълнете от GPSS)} \\
        \hline
        0.200 & 5.00 & \textit{(Попълнете от GPSS)} \\
        \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    %\includegraphics[width=0.8\linewidth]{images/task3_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/task4_hist.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/task5a_results.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/task5b_results.png}
