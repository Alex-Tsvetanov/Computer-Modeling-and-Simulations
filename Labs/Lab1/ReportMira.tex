...
\begin{center}
    ...
    \vspace{0.5cm}
    {\fontsize{14}{16.8}\selectfont\bfseries ФАКУЛТЕТ „КОМПЮТЪРНИ СИСТЕМИ И ТЕХНОЛОГИИ”\par}
    ...
    {\fontsize{20}{24}\selectfont\bfseries ЛАБОРАТОРНО УПРАЖНЕНИЕ №1\par}
    
    \vspace{0.5cm}
    {\fontsize{16}{19.2}\selectfont\bfseries по „Компютърно моделиране и симулации“\par}
    
    \vspace{1.5cm}
    
    {\fontsize{14}{16.8}\selectfont\bfseries Oрганизация и особености на програмна среда за симулация. Изследване на системни характеристики и производителност на компютри\par}
    
    \vfill
    
    \begin{flushleft}
    {\fontsize{14}{16.8}\selectfont\bfseries Изготвил:\par}
    Цветомира Тасева, фак. № 121222180\par
