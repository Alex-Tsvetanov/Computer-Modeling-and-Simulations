...
% Global TikZ overflow fix: wrap in adjustbox (applied per-figure as needed)
...
\begin{center}
    ...
    {\fontsize{20}{24}\selectfont\bfseries ЛАБОРАТОРНО УПРАЖНЕНИЕ №4\par}
    ...
    %{\fontsize{14}{16.8}\selectfont\bfseries Изследване на организацията и системните характеристики на базови конвейерни архитектури\par}
